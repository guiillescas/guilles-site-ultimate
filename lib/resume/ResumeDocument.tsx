...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 18, fontFamily: "Helvetica-Bold", color: "#000" },
  title: { fontSize: 10.5, color: "#333", marginTop: 2 },
  contact: {
    fontSize: 8.8,
    color: "#444",
    marginTop: 5,
  ...
  jobRole: { fontSize: 10, fontFamily: "Helvetica-Bold", color: "#000" },
  jobDates: { fontSize: 8.8, color: "#555" },
  jobCompany: { fontSize: 9.3, color: "#333", marginTop: 1 },
  jobSummary: { color: "#444", marginTop: 2, marginBottom: 2 },
  bullet: { flexDirection: "row", marginTop: 1.2 },
  bulletDot: { width: 10, color: "#666" },
  bulletText: { flex: 1, color: "#333" },

  skills: { color: "#333" },

  eduItem: { marginBottom: 4 },
  eduDegree: { fontSize: 9.3, fontFamily: "Helvetica-Bold", color: "#000" },
