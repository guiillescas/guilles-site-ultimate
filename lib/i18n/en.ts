export const en = {
  ...
  "hero.headline": [
    '<span class="word"><span class="word-inner">Engineering</span></span> ',
    '<span class="word"><span class="word-inner accent">high-performance</span></span> ',
    '<span class="word"><span class="word-inner">web</span></span> ',
    '<span class="word"><span class="word-inner">products</span></span> ',
    '<span class="word"><span class="word-inner">for</span></span> ',
    '<span class="word"><span class="word-inner accent">millions</span></span> ',
    '<span class="word"><span class="word-inner">of</span></span> ',
    '<span class="word"><span class="word-inner">users.</span></span>',
  ].join(""),
  ...
  "work.title": 'Things I\'ve <span class="accent">shipped</span>.',
  "work.visit": "visit",
  "work.prev": "Previous project",
  "work.next": "Next project",

  "p1.subtitle": "a tool for music directors",
  "p1.name": "<strong>Guidefy</strong> — Music director toolkit",
  "p1.desc":
  ...
  "process.c2.body":
    'Palette, type scale, 8pt spacing and motion easing locked in CSS variables before a single layout was drawn. One source of truth — <code style="font-family: var(--font-mono); color: var(--lime); font-size: 12px;">globals.css</code>.',

  "process.c3.eyebrow": "03 / Motion",
  "process.c3.title": "Movement with purpose.",
  "process.c3.body":
  ...
  /* cta */
  "cta.headline": 'Got something <span class="accent">worth building?</span>',
  "cta.btn.call": "Schedule a call",

  /* footer */
  "footer.version": "v2026.01 · made by hand",
